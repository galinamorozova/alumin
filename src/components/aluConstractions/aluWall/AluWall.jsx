            ...
            <div className='container'>
                <div className='menu_content'>
                    ...
                    <div className='aluWallExample'>
                        <img src={aluWall1} alt='алюминиевая перегородка'/>
                        <img src={aluWall2} alt='алюминиевая перегородка'/>
                        <img src={aluWall4} alt='алюминиевая перегородка'/>
                        <img src={aluWall3} alt='алюминиевая перегородка'/>
                    </div>
                <FindPrice/>
                </div>
                </div>
